...
|---:|:---:|---|---|---|:---:|
| 01 | P0 | [Test foundation](./01-test-foundation.md) | Reliable unit, HTTP, race, and database verification | — | Proposed |
| 02 | P0 | [Data integrity and transactions](./02-data-integrity.md) | Valid schema and atomic multi-step mutations | 01 | Proposed |
| 03 | P0 | [WebSocket authorization](./03-websocket-authorization.md) | Only authorized members can subscribe or publish | 01, 02 | Proposed |
| 04 | P0 | [API and abuse protection](./04-api-hardening.md) | Safe validation, origin checks, limits, and consistent errors | 01, 03 | Proposed |
