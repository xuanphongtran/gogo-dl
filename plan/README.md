...
| 04 | P0 | [API and abuse protection](./04-api-hardening.md) | Safe validation, origin checks, limits, and consistent errors | 01, 03 | Ready |
...
Stages 01–03 are complete and tracked as `Done`. Phase 04 is fully specified and marked `Ready`; implementation has not started.
